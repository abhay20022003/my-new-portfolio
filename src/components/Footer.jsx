...
function Footer() {
  return (
    <footer className="bg-gray-800 text-white py-10 px-4 md:px-8 lg:px-36 flex flex-col md:flex-row justify-between items-center text-center md:text-left place-items-center" >
