      ...
      <div className="container mx-auto flex justify-between items-center py-4 px-6">
        ...
        <ul className="hidden md:flex space-x-15 items-center justify-end w-full py-3">
          ...
          <li className="relative dropdown">
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-teal-800 rounded-lg shadow-lg text-white py-3 space-y-6">
      ...
      {isOpen && (
        <ul className="md:hidden bg-gray-800 space-y-4 py-4 text-center">
          ...
          <li className="relative dropdown">
            ...
            {isDropdownOpen && (
              <div className="mt-2 w-full bg-teal-700 text-white py-4 flex flex-col items-center space-y-3">
